...
ProjectMainWindow::ProjectMainWindow()
{
    ...
    reader->SetDirectoryName("F:\\czz\\VHMCT1mm_Shoulder\\Shoulder");
    reader->Update();
    int imageDims[3];
    ...
    riw[1]->SetupInteractor(
        this->qvtkWidget_2->GetRenderWindow()->GetInteractor());

    this->qvtkWidget_3->SetRenderWindow(riw[2]->GetRenderWindow());
    riw[2]->SetupInteractor(
        this->qvtkWidget_3->GetRenderWindow()->GetInteractor());
